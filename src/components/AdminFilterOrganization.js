    ...
    <Box sx={{ flexGrow: 1, backgroundColor: COLORS.white }}>
      <AppBar position="static" sx={{ backgroundColor: '#620b37', height: '100%', width: '100%', backgroundSize: 'contain' }}>
        <Toolbar>
          ...
          <Select value={governorateFilter} onChange={handleGovernorateChange} onMouseEnter={handleGovernorateMouseEnter} onMouseLeave={handleGovernorateMouseLeave} style={{ color: GovernorateHovered ? COLORS.white : COLORS.black, backgroundColor: GovernorateHovered ? 'rgba(98, 11, 55, 0.4)' : COLORS.white, fontWeight: 'bold', width: "15%" }}>
          ...
          <Select value={typeFilter} onChange={handleTypeChange} onMouseEnter={handleTypeMouseEnter} onMouseLeave={handleTypeMouseLeave} style={{ color: TypeHovered ? COLORS.white : COLORS.black, backgroundColor: TypeHovered ? 'rgba(98, 11, 55, 0.4)' : COLORS.white, fontWeight: 'bold', width: "15%" }}>
          ...
          <StyledAccordion key={index}>
            ...
            <AccordionActions style={{ display: "flex", justifyContent: "center" }}>
              <Button
                ...
                size="small"
                style={{ width: "20%", marginLeft: 'auto', marginRight: '30%', margin: 7, color: "#620b37" }}
              ...
              >
                <Button style={{ width: "20%" }} color='error'>Delete</Button>
              </Popconfirm>
            </AccordionActions>
          </StyledAccordion>
        ))}
