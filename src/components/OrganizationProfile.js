                ...
                <ThemeProvider theme={defaultTheme}>
                    <Container component="main" maxWidth="xs">
                        ...
                        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                            <Text variant="h6" style={{ marginBottom: 20, fontSize: 25, position: 'absolute', top: "53%", left: "36.6%", color: '#620B37' }}>Name:</Text>
                            <Grid item xs>
                            ...
                            <Divider />
                            <Grid item xs>
                                <Text variant="h6" style={{ marginBottom: 20, fontSize: 25, position: 'absolute', top: "72%", left: "36.6%", color: '#620B37' }}>Email:</Text>
                                <div style={{ position: 'relative' }}>
                                    <TextField
                                        margin="normal"
                                        fullWidth
                                    ...
                                    {tooltipTextAddress && (
                                        <div style={{ position: 'absolute', top: '75%', left: 0, backgroundColor: 'white', padding: '0px', border: 'transparent', borderRadius: '5px' }}>
                                            {tooltipTextAddress}
                                        </div>
                                    )}
                                    <Divider />
                            ...
                            <Grid item xs>
                                <Text variant="h6" style={{ marginBottom: 20, fontSize: 25, position: 'absolute', top: "108%", left: "36.6%", color: '#620B37' }}>Organization Type:</Text>
                                ...
                                />
                                {tooltipType && (
                                    <div style={{ position: 'absolute', top: '123%', left: '36.5%', backgroundColor: 'white', padding: '0px', border: 'transparent', borderRadius: '5px' }}>
                                        {tooltipType}
                                    </div>
                                )}
                            </Grid>
                            ...
                            <FormControl fullWidth required>
                                ...
                                />
                                {tooltipTextAddress1 && (
                                    <div style={{ position: 'absolute', top: '63%', left: 0, backgroundColor: 'white', padding: '0px', border: 'transparent', borderRadius: '5px' }}>
                                        {tooltipTextAddress1}
                                    </div>
                                )}
                            </FormControl>
                            ...
                            <FormControl fullWidth required style={{ marginBottom: '35px' }}>
                                ...
                                />
                                {tooltipTextZipCode && (
                                    <div style={{ position: 'absolute', top: '95%', left: 0, backgroundColor: 'white', padding: '0px', border: 'transparent', borderRadius: '5px' }}>
                                        {tooltipTextZipCode}
                                    </div>
                                )}
