...
function DonorProfile(){
    ...
    const [email, setEmail] = useState('shady.sherif@gmail.com');
    const [name, setName] = useState('Shady Sherif');
    const [phoneNumber] = React.useState('201015836518');
      ...
      const handleSubmit = (event) => {
        ...
        if (!email ) {
          message.error('Please enter your email.');
            ...
            message.error('Please enter the number of available pro-bono cases.');
        }
        else if (!position){
     ...
     <div style={{ position: 'relative' }}>
      ...
      <Divider/>
            ...
            <Grid item xs fullWidth required>
                    ...
                    <InputLabel id="demo-multiple-name-label">Clinic Location, click on map to change it</InputLabel>
