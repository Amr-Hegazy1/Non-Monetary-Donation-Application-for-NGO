...
const DonorTeacherRequests = () => {
  ...
  return (
    <div className='OrganizationRequests'>
      <h1 className='OrganizationRequests-header'>Teacher Donation Requests</h1>
      <Row justify="center">
      <Col span={12}>
        ...
        >
          {(item) => (
            ...
            <div >
              ...
              <Button className="view-button" type="link" size="small" href='/view-teacher-request-info' >View Info</Button>
          </List.Item>
          )}
        </VirtualList>
      </List>
...
export default DonorTeacherRequests;