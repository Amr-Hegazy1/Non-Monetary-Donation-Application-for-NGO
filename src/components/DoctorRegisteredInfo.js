...
const data = [
  {
    ...
    content: (
      <ul style={{ fontFamily: 'Arial, sans-serif', fontSize: '20px', color: '#333', lineHeight: '1.6', marginLeft: '35px', listStyleType: 'disc' }}>
        <li><p style={{ fontWeight: 'bold' }}>Email:</p>paul.pogba@gmail.com</li>
        <p></p>
        <li><p style={{ fontWeight: 'bold' }}>Contact Number:</p>+201234567890</li>
        <p></p>
        <li><p style={{ fontWeight: 'bold' }}>Role:</p>Doctor</li>
        <p></p>
  ...
  return (
    <>
      ...
      <Container component="main" maxWidth="md">
        <h1 style={{ fontFamily: 'Arial, sans-serif', fontSize: '40px', color: '#620b37', fontWeight: 'bold', textAlign: 'center', marginTop: '15%' }}>Doctor Details</h1>
        <List
          itemLayout="vertical"
          size="large"
          marginCentre='35px'
...
export default DoctorRegisteredInfo;
