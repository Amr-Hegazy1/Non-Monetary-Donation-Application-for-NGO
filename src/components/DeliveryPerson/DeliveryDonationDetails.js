...
export default function DeliveryDonationDetails() {
    ...
    const data = Array.from({
        ...
        content: (
            <ul style={{ fontFamily: 'Arial, sans-serif', fontSize: '20px', color: '#333', lineHeight: '1.6', marginLeft: '35px', listStyleType: 'disc' }}>
                <li><p style={{ fontWeight: 'bold' }}>Address:</p> Floor 1, Apt 3, 5th Settlement, New Cairo</li>
                <p></p>
                <li><p style={{ fontWeight: 'bold' }}>Location:</p><MapComponent /></li>
                <p></p>
                    ...
                    <>
                        ...
                        >
                            <List.Item.Meta
                                ...
                                description={<span style={{ fontSize: '20px', fontFamily: 'Arial, sans-serif', color: '#666', fontStyle: 'italic', marginLeft: "4%" }}>{item.description}</span>} />
